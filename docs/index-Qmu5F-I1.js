...
function normalizePropsOptions(comp, appContext, asMixin = false) {
  ...
  if (isArray$2(raw)) {
    ...
    for (const key in raw) {
      ...
      if (validatePropName(normalizedKey)) {
        const opt = raw[key];
        const prop = normalized[normalizedKey] = isArray$2(opt) || isFunction$1(opt) ? { type: opt } : extend$4({}, opt);
...
const useEpisodeStore = /* @__PURE__ */ defineStore("episode", () => {
  const episodes = ref([]);
  ...
  const filteredEpisodes = computed(() => {
    return episodes.value.filter(
      (episode) => episode.name.toLowerCase().includes(searchQuery.value.toLowerCase())
    );
  });
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        createBaseVNode("header", _hoisted_2$2, [
          ...
          withDirectives(createBaseVNode("input", {
            "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => unref(episodeStore).searchQuery = $event),
            type: "text",
            placeholder: "Search episodes...",
            class: "search-input"
          }, null, 512), [
            [vModelText, unref(episodeStore).searchQuery]
          ])
        ]),
        unref(episodeStore).isLoading ? (openBlock(), createElementBlock("div", _hoisted_3$2, "Loading episodes...")) : unref(episodeStore).error ? (openBlock(), createElementBlock("div", _hoisted_4$2, toDisplayString(unref(episodeStore).error), 1)) : (openBlock(), createElementBlock("div", _hoisted_5$2, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(episodeStore).filteredEpisodes, (episode) => {
            return openBlock(), createBlock(EpisodeCard, {
              key: episode.id,
              episode
            }, null, 8, ["episode"]);
          }), 128))
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("article", _hoisted_1$2, [
        ...
        createBaseVNode("div", _hoisted_3$1, [
          createBaseVNode("h3", _hoisted_4$1, toDisplayString(_ctx.character.name), 1),
          createBaseVNode("div", _hoisted_5$1, [
            createBaseVNode("span", {
              class: normalizeClass(["character-status", `status-${_ctx.character.status.toLowerCase()}`])
            }, toDisplayString(_ctx.character.status), 3),
            createBaseVNode("span", _hoisted_6$1, toDisplayString(_ctx.character.species), 1),
            createBaseVNode("span", _hoisted_7$1, toDisplayString(_ctx.character.gender), 1)
          ])
        ])
      ]);
    };
...
const _hoisted_4 = { class: "episode-card" };
const _hoisted_5 = { class: "episode-info" };
const _hoisted_6 = { class: "episode-title" };
const _hoisted_7 = { class: "episode-meta" };
const _hoisted_8 = { class: "meta-badge episode-number" };
const _hoisted_9 = { class: "meta-badge air-date" };
const _hoisted_10 = { class: "characters-section" };
const _hoisted_11 = {
  key: 0,
  class: "no-characters"
};
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const episodeId = computed(() => parseInt(route.params.id));
    const episodeCharacters = computed(() => {
      if (!episode.value) return [];
      return episode.value.characters.map((url) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        createVNode(_component_router_link, {
          ...
          default: withCtx(() => _cache[0] || (_cache[0] = [
            ...
            createTextVNode(" Все эпизоды ", -1)
          ])),
          _: 1,
          __: [0]
        }),
        isLoading.value ? (openBlock(), createElementBlock("div", _hoisted_2, "Загрузка данных...")) : error.value ? (openBlock(), createElementBlock("div", _hoisted_3, toDisplayString(error.value), 1)) : episode.value ? (openBlock(), createElementBlock(Fragment, { key: 2 }, [
          createBaseVNode("div", _hoisted_4, [
            createBaseVNode("div", _hoisted_5, [
              createBaseVNode("h1", _hoisted_6, toDisplayString(episode.value.name), 1),
              createBaseVNode("div", _hoisted_7, [
                createBaseVNode("span", _hoisted_8, toDisplayString(episode.value.episode), 1),
                createBaseVNode("span", _hoisted_9, toDisplayString(episode.value.air_date), 1)
              ])
            ])
          ]),
          createBaseVNode("div", _hoisted_10, [
            _cache[3] || (_cache[3] = createBaseVNode("h2", { class: "section-title" }, "Персонажи эпизода", -1)),
            episodeCharacters.value.length === 0 ? (openBlock(), createElementBlock("div", _hoisted_11, " Загрузка персонажей... ")) : (openBlock(), createElementBlock("div", _hoisted_12, [
              createVNode(unref(Swiper2), {
                ...
                default: withCtx(() => [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(episodeCharacters.value, (character) => {
                    return openBlock(), createBlock(unref(SwiperSlide), {
                      key: character.id
                    }, {
                      default: withCtx(() => [
                        createVNode(CharacterCard, { character }, null, 8, ["character"])
                      ]),
                      _: 2
                    }, 1024);
                  }), 128)),
                  _cache[1] || (_cache[1] = createBaseVNode("div", { class: "swiper-button-prev" }, null, -1)),
                  _cache[2] || (_cache[2] = createBaseVNode("div", { class: "swiper-button-next" }, null, -1))
                ]),
                _: 1,
                __: [1, 2]
              })
...
const EpisodeDetailView = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-d2e94984"]]);
const _sfc_main = {};
